...
export const metadata: Metadata = {
  title: "Integrative Counselling Resources",
  description: "Registered Social Worker, Psychotherapist, and Clinical Supervisor that is based on racial liberation and anti-oppression principles in downtown Toronto",
};
